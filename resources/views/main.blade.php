    ...
    <body class="antialiased">
        <nav class="nav-tfu navbar back-drop-blur fixed-top navbar-dark bg-dark " style="background-color: #00000036 !important;">
            <div class="container-fluid">
                <div class="r-pos">
                    <div class="logo-animate"><h1 class="a-pos z-1 color-green filter-blur-ulg sm:px-6 lg:px-8 text-center text-sm pd-10 sm:text-left font-big"> Modcord </h1></div>
                    <h1 class="r-pos z-2 sm:px-6 lg:px-8 text-center text-sm pd-10 sm:text-left font-big color-white"> Modcord </h1>
                </div>
        ...
        <!--<script>
            ...
            for (let i = 0; i <= columns*rows*1.5-1; i++){
