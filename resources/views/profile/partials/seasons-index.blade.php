<section>
    <div class="card-wrapper">
        <div class="w-30 card-description leading-relaxed text-zinc-700 dark:text-zinc-200">
            About season 
            <textarea name="new_description" id="new_description-{{$card->id}}" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm width-100 height-100">
                {{$card->description}}
            </textarea>
